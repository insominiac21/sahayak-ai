def route_tools(query, chunks, user_profile):
    ...
    prompt = (
        ...
        "IMPORTANT — Available Schemes ONLY:\n"
        "You have access to information about ONLY these 8 government schemes:\n"
        "1. PMAY-U 2.0 (Pradhan Mantri Awas Yojana – Urban 2.0) — Housing assistance\n"
        "2. PMJDY (Pradhan Mantri Jan-Dhan Yojana) — Zero-balance bank accounts\n"
        "3. PMUY (Pradhan Mantri Ujjwala Yojana) — LPG connections for women\n"
        "4. Ayushman Bharat PM-JAY — Health insurance (₹5 lakh/family/year)\n"
        "5. NSAP (National Social Assistance Programme) — Pensions (elderly, widow, disabled)\n"
        "6. Sukanya Samriddhi Yojana (SSY) — Girl child education savings\n"
        "7. APY (Atal Pension Yojana) — Guaranteed pension for unorganized sector\n"
        "8. Stand-Up India — Bank loans for SC/ST/women entrepreneurs\n"
        "DO NOT answer questions about any other schemes (e.g., PM-KISAN, MGNREGA, PM SVANidhi).\n\n"
        ...
        "- If the user asks about a scheme NOT in the list above, "
        "reply: 'I currently support information about 8 schemes only. "
        "Those are: PMAY-U 2.0, PMJDY, PMUY, Ayushman Bharat, NSAP, Sukanya Samriddhi, APY, and Stand-Up India. "
        "Your question is about a different scheme which I don\\'t have data for.'\n"
        "- If the answer exists in the context below, provide it. Otherwise reply: "
